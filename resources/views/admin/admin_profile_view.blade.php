...
<div class="page-content">
        ...
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="mb-3">
                ...
                <img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/admin_image/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
            </div>
    ...
    {{-- this code snipit make the photo authoload  --}}
    <script type="text/javascript">
      $(document).ready(function(){
        $('#image').change(function(e){
          ...
          reader.readAsDataURL(e.target.files[0]); // changed from readAsDataUrl to readAsDataURL
        });
      });
    </script>

        ...
        <div class="flex-grow-1 me-2">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{ (!empty($data->photo)) ? url('upload/admin_image/'.$data->photo) : url('upload/no_image.jpg') }}" alt="profile">
                </a>
                <div class="p-0 dropdown-menu" aria-labelledby="profileDropdown">
                    <div class="px-5 py-3 d-flex flex-column align-items-center border-bottom">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{ (!empty($data->photo)) ? url('upload/admin_image/'.$data->photo) : url('upload/no_image.jpg') }}" alt="">
                        </div>
